        ...
        stages {
            ...
            stage('deploy') {
                steps {
                    ...
                    sh "sudo docker exec projet-federateur-job_spark-master_1 /bin/bash -c './bin/spark-submit --class org.example.StreamingJob --master spark://projet-federateur-job_spark-master_1:7077 --deploy-mode cluster --packages org.apache.spark:spark-sql-kafka-0-10_2.12:3.0.0 spark-demo-1.0-SNAPSHOT-jar-with-dependencies.jar'"
                }
            }
        }
}

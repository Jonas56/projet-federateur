        ...
        stages {
            ...
            stage('deploy') {
                steps {
                    ...
                    sh 'docker cp /var/jenkins_home/workspace/spark-job/target/spark-demo-1.0-SNAPSHOT-jar-with-dependencies.jar docker-spark-cluster-master_spark-master_1:/opt/spark'
